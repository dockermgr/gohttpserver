...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/gohttpserver"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="gohttpserver"
INSTDIR="$HOME/.local/share/dockermgr/gohttpserver"
APPDIR="$HOME/.local/share/srv/docker/gohttpserver"
DATADIR="$HOME/.local/share/srv/docker/gohttpserver/files"
...
HUB_URL="casjaysdevdocker/gohttpserver:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "gohttpserver"; then
